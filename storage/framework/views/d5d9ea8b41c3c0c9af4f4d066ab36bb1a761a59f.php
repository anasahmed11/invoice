    ...
    <div class="<?php echo e($auth_type ?? 'login'); ?>-box">
        ...
        <div class="<?php echo e($auth_type ?? 'login'); ?>-logo">
            <a href="<?php echo e($dashboard_url); ?>">
                ...
                <b style="color: white;font-family: Fredoka One, cursive;">Dayra</b>
            </a>
        </div>
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\dayra\resources\views/vendor/adminlte/auth/auth-page.blade.php ENDPATH**/ ?>