    ...
    <div class="container">
                ...
                <table class="table table-bordered table-hover " >
                    ...
                    <tr>
                        <div class="col-md-6">
                            ...
                            <td >
                                <select class="form-control customer_id " style="height: 200px ; width: 100% ;"   name="products_invoice" >
                                    <option value=""  >choose invoice</option>
                                    <?php $__currentLoopData = $products_invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row clearfix" style="margin-top:20px">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <a href="<?php echo e(route('inventory-products-invoice-index')); ?>" style="color: white"> <button  type="button" class="btn btn-danger btn-block"><i class="far fa-arrow-alt-circle-left"></i> Back </button></a><br><br>
                </div>
            </div>
        </form>
    </div>
        ...
        $(document).ready(function(){
            ...
            $('.sub_category_id').select2({
                ...
                $(document).on("click", "#add-invoice", function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'inventory-products-invoice',
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\amwal-pos\resources\views/admin/pages/inventory-products-invoice/customer-invoice.blade.php ENDPATH**/ ?>
