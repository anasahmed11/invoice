...
<?php $__env->startSection('content'); ?>
    <div >
        <div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <button class="btn btn-dark btn-block " ><a href="<?php echo e(route('inventory-invoice')); ?>" style="color: white"><i class="fas fa-cart-plus"></i> Add new</a></button><br><br>
                </div>
                <div class="col-md-3">
            ...
            <form >
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <button class="btn btn-danger " ><a href="<?php echo e(route('inventory-invoice-index')); ?>" style="color: white"><i class="far fa-arrow-alt-circle-left"></i> back</a></button><br><br>
                    </div>
                        ...
                        <table class="article-table table table-striped  ">
                            ...
                            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="invoice-<?php echo e($row->id); ?>">
                                    ...
                                    <td><?php echo e($row->sales_invoice_id); ?></td>
    ...
    <script>
        $( document ).ready(function() {
            ...
            $(document).on('click',".details",function(e){
                ...
                $.ajax({
                    type: 'GET',
                    url: 'inventory-invoice-details/'+id,
                    processData: false,
            ...
            $(document).on("click", "#excel", function(e) {
                ...
                $.ajax({
                    type: "GET",
                    Content: "text/csv",
                    url: 'export-all-inventory-sales-invoices?from_date=' + from_date + '&to_date=' + to_date,
                    success: function(data) {
                        window.location.href = 'export-all-inventory-sales-invoices?from_date=' + from_date +
                            '&to_date=' + to_date ;
                    }
                });
                e.preventDefault();
            ...
            $(document).on("click", ".pdf", function(e) {
                ...
                $.ajax({
                    type: "GET",
                    Content: "text/csv",
                    url: 'export-inventory-invoice-details/'+id,
                    success: function(data) {
                        window.location.href = 'export-inventory-invoice-details/'+id ;
                    }
                });
                e.preventDefault();
            });
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\amwal-pos\resources\views/admin/pages/inventory-invoice/index.blade.php ENDPATH**/ ?>
