        ...
        <div>
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1><b>Purchase-Pre-Products Invoices</b></h1><br>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3 ">
            ...
            <div class="row">
                <div class="col-md-4 ">
                    <button class="btn btn-dark " ><a href="<?php echo e(route('purchases-pre-products-invoice')); ?>" style="color: white"><i class="fas fa-cart-plus"></i> Add new</a></button><br><br>
                </div>
            ...
            <form >
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <button class="btn btn-danger " ><a href="<?php echo e(route('purchases-pre-products-invoice-index')); ?>" style="color: white"><i class="far fa-arrow-alt-circle-left"></i> back</a></button><br><br>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php echo e(Form::select('payment_type', array(''=>'choose','paid'=>'paid','not-paid'=>'not-paid','partially-paid'=>'partially-paid'),null, array('class' => 'form-control '))); ?><br>
                    </div>
                    <div class="col-md-3">
    ...
    <script>
        $( document ).ready(function() {
            ...
            $(document).on('click',".details",function(e){
                ...
                $.ajax({
                    type: 'GET',
                    url: 'purchases-pre-products-invoice-details/'+id,
                    processData: false,
            ...
            $(document).on("click", "#excel", function(e) {
                ...
                $.ajax({
                    type: "GET",
                    Content: "text/csv",
                    url: 'export-all-purchases-pre-products-invoices?from_date=' + from_date + '&to_date=' + to_date,
                    success: function(data) {
                        window.location.href = 'export-all-purchases-pre-products-invoices?from_date=' + from_date +
                            '&to_date=' + to_date ;
                    }
                });
                e.preventDefault();
            ...
            $(document).on("click", ".pdf", function(e) {
                ...
                $.ajax({
                    type: "GET",
                    Content: "text/csv",
                    url: 'export-purchases-pre-products-invoice-details/'+id,
                    success: function(data) {
                        window.location.href = 'export-purchases-pre-products-invoice-details/'+id ;
                    }
                });
                e.preventDefault();
            });
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\amwal-pos\resources\views/admin/pages/purchases-pre-products-invoice/index.blade.php ENDPATH**/ ?>